...
data. Unlike categorical data, ordinal data does have a natural order to the 
...
```
![Bar graph of obesity and recurrence](../fig/04-fig1.png)
...
```
![Stacked bar graph of obesity and recurrence](../fig/04-fig2.png)
...
> > 
> > # Look at expected values to select Chi-square or Fisher's exact test
...
> > non-significant, so we fail to reject the null hypothesis and cannot conclude 
> > that treatment has an effect on recurrence rate.
> {: .solution}
{: .challenge}
