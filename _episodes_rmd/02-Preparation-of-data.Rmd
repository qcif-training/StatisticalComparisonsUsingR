...
> ## Tip: info about read.table, read.csv, read.csv2 - latter are just aliases
for specific cases)
{: .callout}
...
Use read.csv to upload the file into a dataframe called ‘data’
Look at the structure of the dataframe using str and summary
Patient identifiers probably shouldn’t be a factor – unique for each entry. Use as.character to convert that column to character data
